...
module.exports = {
    ...
    plugins: [
        ...
        },
        {
            ...
            options: {
                url: process.env.WPGRAPHQL_URL || `http://plugindev.local/graphql`,
                verbose: true,
                schema: {
                    queryDepth: 5,
                    typePrefix: `Wp`,
                ...
                type: {
                    Post: {
                        limit: process.env.NODE_ENV === `development` ? // Lets just pull 50 posts in development to make it easy on ourselves.
