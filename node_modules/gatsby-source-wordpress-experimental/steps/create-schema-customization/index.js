...
const customizeSchema = async ({
  ...
  remoteSchema.introspectionData.__schema.types.forEach(type => {
    if ((0, _helpers.fieldOfTypeWasFetched)(type) && !(0, _isExcluded.typeIsExcluded)({
      ...
      switch (type.kind) {
        case `UNION`:
          _buildTypes.default.unionType(Object.assign(Object.assign({}, typeBuilderApi), {}, {
            type
          }));
        ...
        case `INTERFACE`:
          _buildTypes.default.interfaceType(Object.assign(Object.assign({}, typeBuilderApi), {}, {
            type
          }));
        ...
        case `OBJECT`:
          _buildTypes.default.objectType(Object.assign(Object.assign({}, typeBuilderApi), {}, {
            type
          }));
